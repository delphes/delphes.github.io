...
[Download](/etc/HZZ.C) the HZZ.C macro and save in the "examples" directory. Then open it with your favorite text editor, and make sure you understand what it does. Then run it:
...
[/workbook/modules](/workbook/modules)
...
12\) [Download](/etc/TimingAnalysis.C) this macro and run it. This macro isolates the four highest PT tracks. The hard vertex is taken to be that given by the most energetic track. The difference in time between the first and the fourth track is plotted. Explain what you see.
